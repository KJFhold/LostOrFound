...
const dictionaries = {
  en: {
    ...
    "chat.unavailable": "The conversation is unavailable.",
    "reports.extendTooEarlyTitle": "Too early to extend",
    "reports.extendTooEarlyBody": "The report can be extended when seven days or less remain.",
    "reports.extendLimitTitle": "Extension limit reached",
    "reports.extendLimitBody": "This found report has already used both extensions.",
    "reports.maxAgeTitle": "Maximum active period reached",
    "reports.maxAgeBody": "The found report has reached the maximum active period of 90 days.",
    "reports.closedTitle": "Case already closed",
    "reports.closedBody": "This case is already closed and cannot be changed.",
  },
  no: {
    "tabs.home": "Hjem",
    ...
    "chat.title": "Chat",
    "chat.subtitle": "Meldinger",
    "chat.loading": "Laster…",
    "chat.placeholder": "Skriv en melding…",
    "chat.send": "Send",
    "chat.errorTitle": "Noe gikk galt",
    "chat.loadError": "Kunne ikke hente meldinger.",
    "chat.sendError": "Kunne ikke sende meldingen.",
    "chat.unavailable": "Samtalen er ikke tilgjengelig.",
    "reports.extendTooEarlyTitle": "For tidlig å forlenge",
    "reports.extendTooEarlyBody": "Rapporten kan forlenges når det er sju dager eller mindre igjen.",
    "reports.extendLimitTitle": "Grensen for forlengelser er nådd",
    "reports.extendLimitBody": "Denne funnet-rapporten har allerede brukt begge forlengelsene.",
    "reports.maxAgeTitle": "Maksimal aktiv periode er nådd",
    "reports.maxAgeBody": "Funnet-rapporten har nådd maksimal aktiv periode på 90 dager.",
    "reports.closedTitle": "Saken er allerede avsluttet",
    "reports.closedBody": "Denne saken er allerede avsluttet og kan ikke endres.",
  },
} as const;
