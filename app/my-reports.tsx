...
export default function MyReportsScreen() {
  ...
  const openReport = (r: Report) => {
    router.push({ pathname: "/report-details/[id]", params: { id: r.id } });
  };
